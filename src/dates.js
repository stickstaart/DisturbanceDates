const pastShows = [
...

  {
    ...
    city: 'Düsseldorf',
    venue: 'AK47',
    name: 'Apunkalypse Flingern',
    tour: '',
    with: 'Angerboys, Bug Attack, Graupause, Rumble Deluxe, Sons of Ritalin, Lightstrucks, Fleischwolf, Nausea Bomb,' +
      ' Big Bull and his Selfish Band',
  },
...

  {
    ...
    name: 'Kempenerpop',
    tour: '',
    with: 'Outerspass, De Kraaien, Demented Are Go, The Capaces, Speedmobile, 69Charger, DJ Jean, Sjek, Bob Wayne,' +
      ' Willy Organ, Small Time Crooks, LE MOTAT, The Darkraver, Dune, DJ Potato, DJ J.D.A., Critical Mass,' +
      ' Mainstage Maffia, T-Go vs Highforce, Remsy, Headless Freaks, Another Now, Steppin’ Ground Soundsystem, Brand' +
      ' New Sticks, New Dawn, Daring Darling, Vleesmeesters, Brake Company, Rise a Thousand',
  },
